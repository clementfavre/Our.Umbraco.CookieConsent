...
public class DictionaryKeySeeder
{
    ...
    public DictionaryKeySeeder(ILocalizationService localizationService, ILogger<CookieConsentService> logger, IOptions<CookieConsentOptions> options)
    {
    ...
    private Guid? CreateKey(string key, string value, Guid? parentKey = null)
    {
        try
        {
            ...
            {
                _logger.Log(SeedLogLevel, "Key already exists: {Key}", key);
            ...
            _logger.Log(SeedLogLevel, "Created translation key: {Key}", key);
            return item.Key;
        }
        catch (Exception ex)
        {
